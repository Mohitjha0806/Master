...
<body class="bg-dark">
    <form id="form1" runat="server">
        <div class="container ">
            ...
            <div class="container w-50 h-auto">
                <div class="row ">
                ...
                <div class="row d-flex justify-content-center">
                    <p class="display-5 fw-bold text-center text-light">We have a problum.</p>
                    <p class="display-6 fw-bold text-center text-light">Page not found.</p>
                    <a class="text-center" href="LoginPage.aspx">Go back to the login page</a>
                </div>
            </div>
