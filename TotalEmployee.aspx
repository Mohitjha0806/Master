<%@ Page Title="" Language="C#" MasterPageFile="~/CommonPage.master" AutoEventWireup="true" CodeFile="TotalEmployee.aspx.cs" Inherits="TotalEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card">
        ...
        <div runat="server" class="card-header">
            ...
            <h1 class="fw-semibold fs-3">Total Employees</h1>
        </div>
