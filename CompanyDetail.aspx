                    ...
                    <fieldset>
                        ...
                        <from class="form-control py-2">
                            ...
                            <div class="row mt-3 ">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList CssClass="form-control form-select fw-semibold py-3 mt-1" Style="font-size: 0.8rem; border-color: #717FF5;" ID="ddlCompanystate" runat="server" OnSelectedIndexChanged="ddlCompanystate_SelectedIndexChanged" AutoPostBack="true">
